...
(function () {
  ...
  // self-hosted weights in ./models, page-relative so it resolves correctly both
  // as a standalone GitHub Pages site (served from a project subpath) and when
  // embedded at /stock-game/. No trailing slash — face-api appends "/<manifest>.json".
